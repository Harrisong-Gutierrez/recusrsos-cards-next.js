const cardData = [
    {
        ...
        paragraph: 'It is one of the favorite destinations for national and international tourists and a mandatory stop to visit in summer. San Juan del Sur is a natural treasure of sun and sand located 140 kilometers from Managua.'
    },
    {   
        url:"https://www.visitcentroamerica.com/visitar/corn-island/",
        customclass: "img-2-",
        Text: "Corn Island",
        paragraph: 'Surrounded by turquoise water and white sand, South West Beach in Corn Island is a hidden treasure in the Autonomous Region of the South Caribbean Coast of Nicaragua.'
    },
    {   
        ...
        customclass: "img-3-",
        Text: "Montelimar",
        paragraph: 'Considered an icon of the natural beauty of the Nicaraguan Pacific, Montelimar is one of the most exclusive beaches in the country, surrounded by impressive and exuberant tropical vegetation.'
    },
     {
        url:"https://confidencial.digital/revista-niu/tendencias/una-guia-para-visitar-y-disfrutar-de-las-mejores-playas-de-nicaragua/",
        customclass: "img-1-",
